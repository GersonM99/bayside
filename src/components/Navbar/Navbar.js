  ...
  return (
    <nav className="app__navbar">
      ...
      <ul className="app__navbar-links">
        ...
        <li className="p__opensans"><a href="#awards">Amenidades</a></li>
        <li className="p__opensans"><a href="#contact">Contacto</a></li>
      </ul>
      <div className="app__navbar-login">
        <a href="#login" className="p__opensans">inicia sesión / Registrate</a>
        <div />
        ...
        {toggleMenu && (
          <div className="app__navbar-smallscreen_overlay flex__center slide-bottom">
            ...
            <ul className="app__navbar-smallscreen_links">
              ...
              <li><a href="#awards" onClick={() => setToggleMenu(false)}>amenidades</a></li>
